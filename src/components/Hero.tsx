        ...
        <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-16 lg:items-center min-h-[80vh]">
          ...
          <div className="order-1 lg:order-2 lg:col-span-2 relative">
            <div className="animation-container relative w-full h-[300px] md:h-[400px] lg:h-[600px] xl:h-[700px] fade-in-up stagger-delay-4">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-light-gray/30 to-white rounded-3xl">
                ...
                <div className="hidden md:block absolute top-20 left-20 w-20 h-20 bg-primary-yellow rounded-full floating-animation opacity-80"></div>
                <div className="absolute top-8 md:top-40 right-4 md:right-10 w-12 md:w-16 h-12 md:h-16 bg-primary-yellow/60 rounded-full coin-float stagger-delay-1"></div>
                <div className="hidden md:block absolute bottom-40 left-10 w-24 h-24 bg-primary-yellow/40 rounded-full floating-animation stagger-delay-2"></div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 md:w-12 h-8 md:h-12 bg-charcoal-black/10 rounded-full floating-animation stagger-delay-4"></div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <div className="w-24 md:w-40 h-24 md:h-40 bg-primary-yellow/80 rounded-full flex items-center justify-center coin-float">
                    <div className="w-20 md:w-32 h-20 md:h-32 bg-white rounded-full flex items-center justify-center shadow-lg">
                      <svg className="w-8 md:w-16 h-8 md:h-16 text-charcoal-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="order-2 lg:order-1 lg:col-span-3 space-y-6 lg:space-y-8 text-center lg:text-left pt-8 lg:pt-0">
            ...
            <div className="fade-in-up">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-playfair font-bold text-charcoal-black leading-tight mb-4 lg:mb-6">
            ...
            <div className="fade-in-up stagger-delay-1">
              <p className="font-futura text-lg sm:text-xl lg:text-2xl text-charcoal-black leading-relaxed max-w-2xl mx-auto lg:mx-0">
