          ...
          <div className="order-1 lg:order-2 lg:col-span-2 relative">
            <div className="animation-container relative w-full h-[300px] md:h-[400px] lg:h-[600px] xl:h-[700px] fade-in-up stagger-delay-4">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-deep-navy/50 to-dark-navy/30 rounded-3xl">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 md:w-12 h-8 md:h-12 bg-dark-navy/10 rounded-full floating-animation stagger-delay-4"></div>
                ...
                <div className="absolute top-6 md:top-10 right-1/4 md:right-1/3 w-6 md:w-8 h-6 md:h-8 bg-dark-navy/20 transform rotate-45 floating-animation stagger-delay-5"></div>
