        ...
        <div className="flex items-center justify-between h-14 sm:h-16 md:h-20 lg:h-24">
          ...
          >
            <div className="flex-shrink-0">
              <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full flex items-center justify-center logo-hover p-1 sm:p-1.5 md:p-2" style={{ backgroundColor: '#1B1B1B' }}>
                <img 
